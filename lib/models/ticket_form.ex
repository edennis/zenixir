defmodule Zendesk.TicketForm do
  @moduledoc """
  Zendesk Ticket Form
  """
  ...
  def from_json(json) do
    Poison.Parser.parse(json, keys: :atoms) |> elem(1) |> Dict.get(:ticket_form)
  end

  def from_json_array(json) do
    Poison.Parser.parse(json, keys: :atoms) |> elem(1) |> Dict.get(:ticket_forms)
  end
